...
class OrdersTable(Base):
    ...
    codigo_cliente = Column(String, nullable=True, default="Não Informado")
    loja_cliente = Column(String, nullable=True, default="Não Informado")
    nome_do_cliente = Column(String, nullable=True, default="Não Informado")
    cnpj_do_cliente = Column(String, nullable=True, default="Não Informado")
    cnpj_de_faturamento = Column(String, nullable=True, default="Não Informado")
    cnpj_de_remessa = Column(String, nullable=True, default="Não Informado")
    equipamento = Column(String, nullable=True, default="Não Informado")
    nota_de_remessa = Column(String, nullable=True, default="Não Informado")
    data_de_remessa = Column(Date)
    serie_da_nf_remessa = Column(String, nullable=True, default="Não Informado")
    produto = Column(String, nullable=True, default="Não Informado")
    descricao_do_produto = Column(String, nullable=True, default="Não Informado")
    quantidade = Column(Integer)
    pedido_de_remessa = Column(String, nullable=True, default="Não Informado")
    projeto = Column(String, nullable=True, default="Não Informado")
    obra = Column(String, nullable=True, default="Não Informado")
    prazo_do_contrato = Column(String, nullable=True, default="Não Informado")
    ...
    desc_ajuste = Column(String, nullable=True, default="Não Informado")
    indice_aplicado = Column(String, nullable=True, default="Não Informado")
    dias_de_locacao = Column(Integer)
    valor_de_origem = Column(String, nullable=True, default="Não Informado")
    valor_unitario = Column(String, nullable=True, default="Não Informado")
    valor_bruto = Column(String, nullable=True, default="Não Informado")
    tipo_do_mes = Column(String, nullable=True, default="Não Informado")
    #nr_chamado = Column(String, nullable=True, default="Não Informado")
    contrato_legado = Column(String, nullable=True, default="Não Informado")
    acrescimo = Column(String, nullable=True, default="Não Informado")
    franquia = Column(String, nullable=True, default="Não Informado")
    id_equipamento = Column(String, nullable=True)
    id_equip_substituido = Column(String, nullable=True, default="Não Informado")
    data_da_substituicao = Column(Date)
    data_proximo_faturamento = Column(Date)
    #data_inicio = Column(Date)
    data_fim_locacao = Column(Date)
    tipo_de_servico = Column(String, nullable=True, default="Não Informado")
    email = Column(String, nullable=True, default="Não Informado")
    calculo_reajuste = Column(String, nullable=True, default="Não Informado")
    nome_da_obra = Column(String, nullable=True, default="Não Informado")
    numero_da_as = Column(String, nullable=True, default="Não Informado")
    pedido_faturamento = Column(String, nullable=True, default="Não Informado")
    nf_de_faturamento = Column(String, nullable=True, default="Não Informado")
    serie_de_faturamento = Column(String, nullable=True, default="Não Informado")
    data_de_faturamento = Column(Date)
    qtde_faturamento = Column(Integer)
    vlr_unitario_faturamento = Column(String, nullable=True, default="Não Informado")
    vlr_total_faturamento = Column(String, nullable=True, default="Não Informado")
    periodo_de_faturamento = Column(String, nullable=True, default="Não Informado")
    status_de_cobranca = Column(String, nullable=True, default="Não Informado")
